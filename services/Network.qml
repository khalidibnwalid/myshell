...
Scope {
    ...
    property bool enabled: wifiEnabled // add ethernet check later
    property bool connected: active !== null
    ...
    property string statusIcon: {
        ...
        if (connected)
            return getStatusIcon(active.strength);

        return "signal_wifi_0_bar";
    }

    function getStatusIcon(strength) {
        if (strength > 75)
